    ...
    <main className="py-14 md:py-20">
      <Container>
        ...
        <p className="text-muted text-lg max-w-3xl mt-3">
          Here are simple scripts that dramatically increase response rates when
        ...
        <div className="rounded-2xl border border-border/60 bg-panel/40 p-6 mt-8">
          ...
          <div className="mt-4 space-y-4 text-muted">
            <div>
              ...
              <p>
                “Hey {"{{name}}"} — got your request. What’s the main goal: (A)
                book ASAP, (B) pricing info, or (C) questions first?”
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                “Quick check-in — want me to send availability or answer a
            ...
            <div>
              ...
              <p>
                “Still want help with {"{{service}}"}? If yes, I can get you
