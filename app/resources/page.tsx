  ...
  return (
    ...
    >
      ...
      <div
        className={
          isFeatured
            ? "relative h-[340px] sm:h-[380px] overflow-hidden"
      ...
      <div className={isFeatured ? "p-7 sm:p-8" : "p-6"}>
        ...
        <p className="mt-4 text-sm text-muted leading-relaxed">{r.description}</p>
        ...
        <p className="mt-3 text-xs text-muted">
          Instant access. No fluff. Clear next steps.
        </p>
      </div>
    </div>
  );
